...
export function Footer() {
  return (
    <footer className="agorm-footer border-t border-slate-800 bg-black px-5 py-10 backdrop-blur-sm sm:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-300">Digital products for a fast-changing world.</p>
        </div>
      ...
      <p className="mx-auto mt-8 max-w-7xl text-xs text-slate-400">Copyright {new Date().getFullYear()} AGOM. All rights reserved.</p>
    </footer>
  );
}

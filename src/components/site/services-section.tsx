          ...
          {services.map((service, index) => {
            ...
            return (
              <SectionReveal key={service.title} delay={index * 0.06}>
                <article className="group h-full rounded-2xl border border-white/10 bg-slate-900/60 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/40 hover:bg-slate-900">
                  <div className="mb-5 inline-flex rounded-xl bg-white/5 p-3 text-cyan-200 transition-colors duration-300 group-hover:bg-cyan-400/10 group-hover:text-cyan-100">
                    <Icon size={22} />
                  </div>

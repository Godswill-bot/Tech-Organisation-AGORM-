...
export function FeaturesSection() {
  ...
  return (
    <section ref={sectionRef} id="features" className="relative overflow-hidden bg-black px-5 py-24 text-white sm:px-8 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          ...
          <div className="rounded-4xl border border-white/10 bg-white/5 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.26)] backdrop-blur-ms">
          ...
          {featureCards.map((feature, index) => {
            ...
            return (
              <div
                ...
                className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/6 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.18)] backdrop-blur-ms transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(0,0,0,0.24)]"
              >
